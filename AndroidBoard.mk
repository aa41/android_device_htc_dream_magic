...
# from device/htc/dream_magic
file := $(TARGET_OUT_KEYLAYOUT)/sapphire-keypad.kl
ALL_PREBUILT += $(file)
$(file) : $(LOCAL_PATH)/sapphire-keypad.kl | $(ACP)
	$(transform-prebuilt-to-target)

file := $(TARGET_ROOT_OUT)/init.magic.rc
ALL_PREBUILT += $(file)
$(file) : $(LOCAL_PATH)/init.magic.rc | $(ACP)
	$(transform-prebuilt-to-target)
...
file := $(TARGET_OUT)/build.magic.prop
ALL_PREBUILT += $(file)
$(file) : $(LOCAL_PATH)/build.magic.prop | $(ACP)
	$(transform-prebuilt-to-target)
...
-include vendor/htc/dream_magic/AndroidBoardVendor.mk
