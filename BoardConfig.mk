...
-include vendor/htc/dream_magic/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_LIBS := \
	libboot_board_dream_magic_combined \
	libboot_arch_msm7k \
	libboot_arch_armv6
...
BOARD_EGL_CFG := device/htc/dream_magic/egl.cfg
...
TARGET_OTA_ASSERT_DEVICE := trout,magic
PRODUCT_BUILD_PROP_OVERRIDES += TARGET_BOOTLOADER_BOARD_NAME=magic
...
TARGET_PREBUILT_KERNEL := device/htc/dream_magic/kernel
